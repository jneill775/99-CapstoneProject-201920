...
def main():
    ...
    # -------------------------------------------------------------------------
    teleop_frame,are_frame,control_frame,drive_system_frame,sound_system_frame=get_shared_frames(main_frame,mqtt_sender)
    ...
    # Grid the frames.
    # -------------------------------------------------------------------------
    grid_frames(teleop_frame,are_frame,control_frame,drive_system_frame, sound_system_frame)
